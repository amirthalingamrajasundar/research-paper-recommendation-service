"""
Sentence Transformer recommendation service.
"""
import os
import sys
...
EMBEDDINGS_PATH = os.getenv("EMBEDDINGS_PATH", str(PROJECT_ROOT / "models/sentence_transformer/embeddings.npy"))
BASE_MODEL = os.getenv("BASE_MODEL", "all-MiniLM-L6-v2")
MODEL_NAME = "base_transformer"


class SentenceTransformerService:
    """Sentence Transformer based recommendation service."""
    ...
    def load(self):
        ...
        print(f"Loading Sentence Transformer model: {BASE_MODEL}...")
...
# FastAPI app
app = FastAPI(
    title="Sentence Transformer Recommendation Service",
    version="1.0.0",
    lifespan=lifespan
)
